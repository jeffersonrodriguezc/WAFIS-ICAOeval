...
class InjectionOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--epsilon', default=3, type=float, help="Constraint value for delta")
        self.parser.add_argument('--step_size', default=0.045, type=float)
        ...
        self.parser.add_argument('--rec_weight', default=15.0, type=float, help="Weight to preserve watermark/visuals")
