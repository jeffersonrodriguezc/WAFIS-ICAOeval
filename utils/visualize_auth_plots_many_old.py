...
def load_distances(exp_path: Path, train_dataset: str, dataset: str, metric: str, FRModel: str) -> Dict[str, Dict[str, np.ndarray]]:
...
def main():
    ...
    for _, bpp_str, exp_path in exp_info:
        for ds in args.datasets:
            data = load_distances(exp_path, args.train_dataset, ds, args.metric, args.FRModel)
